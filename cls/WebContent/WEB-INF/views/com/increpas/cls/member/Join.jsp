	...
	<div class="w3-content w3-center mw650">
		...
		<form method="POST" action="/cls/member/joinProc.cls" 
			...
			<div class="w3-col">
				...
				<div class="w3-col l9 m12 w3-padding">
					<div class="w3-half">
						<input type="radio" class="w3-radio w3-radio-small gen" id="genM" name="gen" value="M"><span> 남 자</span>
					</div>
					<div class="w3-half">
						<input type="radio" class="w3-radio w3-small gen" id="genF" name="gen" value="F"><span> 여 자</span>
					</div>
				</div>
			</div>
